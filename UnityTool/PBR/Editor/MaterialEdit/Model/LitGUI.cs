...
namespace Custom
{
    public class LitGUI
    {
        ...
        public static class Styles
        {
            ...
            public static GUIContent specularSmoothnessText = new GUIContent("Specular Smoothness", "");
        }
        ...
        public struct LitProperties
        {
            ...
            public LitProperties(MaterialProperty[] properties)
            {
                ...
                specularSmoothness = BaseShaderGUI.FindProperty("_SpecularSmoothness", properties, false);
            }
        }
