...
namespace UnityEditor
{
	public class CalmWaterInspector: ShaderGUI
	{
		...
		MaterialProperty _FoamFrequency = null;
		...
		public void FindProperties(MaterialProperty[] props)
		{
			...
			specPow = FindProperty("_SpecPow", props);
			...
			_FoamFrequency = FindProperty("_FoamFrequency", props);
        ...
        public void ShaderPropertiesGUI(Material material)
		{
			...
			EditorGUI.BeginChangeCheck();
			{
				...
				m_MaterialEditor.ShaderProperty(specPow, "SpecPow");
				...
				if(foamToggle.floatValue == 1)
				{
					...
					m_MaterialEditor.ShaderProperty(_FoamFrequency, "Foam Frequency");
					m_MaterialEditor.ShaderProperty(_FoamSpeed, "Foam Speed");
				}
