#ifndef CUSTOM_FACE_INPUT_INCLUDED
    #define CUSTOM_FACE_INPUT_INCLUDED
    ...
    TEXTURE2D(_3SRampMap);             SAMPLER(sampler_3SRampMap);
    ...
    inline void InitializeStandardLitSurfaceData(float2 uv, out SurfaceData outSurfaceData,half3 msa)
    {
        ...
        outSurfaceData.metallic =  _MetaStrength;
        ...
        //outSurfaceData.normalTS = ApplyDetailNormal(uv * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw, outSurfaceData.normalTS, 1);
    }
