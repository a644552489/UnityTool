...
Shader "UC/Actor/Protagonist/High/ToonHair"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        float _SpecularSize;
            ...
            Varings vert(Attributes IN)
            {
                ...
                OUT.bitangentWS = sign * cross(OUT.normalWS.xyz, OUT.tangentWS.xyz);
            ...
            float4 frag(Varings IN):SV_Target
            {
                ...
                float3 T = TransformTangentToWorld(IN.tangentWS, half3x3(IN.tangentWS.xyz, IN.bitangentWS.xyz, IN.normalWS.xyz));
